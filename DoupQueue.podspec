...
Pod::Spec.new do |s|
  s.name             = "DoupQueue"
  s.version          = "0.1.0"
  s.summary          = "A short description of DoupQueue."
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = "https://github.com/<GITHUB_USERNAME>/DoupQueue"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Milan Kamilya" => "milan.kamilya@innofied.com" }
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/DoupQueue.git", :tag => s.version.to_s }
